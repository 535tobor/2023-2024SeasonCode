...
import static org.firstinspires.ftc.teamcode.operations.outputs.motors.drive.Mecanum.goDirection;
...
public class AprilTag {
    ...
    public static void searchForTagByControlled(double speed) {

        if (tagId != alignTagControlled) {
            goDirection(speed); // if the desired AprilTag is not found then go the desired direction until the april tag is found
        }
