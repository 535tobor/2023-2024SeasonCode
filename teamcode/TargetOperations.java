...
public abstract class TargetOperations extends LinearOpMode {
    ...
    // 1 motor for lifting onto arm, 1 for pixels
    ...
    public void imuGet (String hardwareMapImuName, String logoFacing, String usbFacing) {
        // Retrieve the IMU from the hardware map
        imu = hardwareMap.get(IMU.class, hardwareMapImuName);
        IMU.Parameters parameters = null;
        // Adjust the orientation parameters to match your robot
        if (logoFacing == "UP" && usbFacing == "FORWARD") {
            parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                    RevHubOrientationOnRobot.LogoFacingDirection.UP,
                    RevHubOrientationOnRobot.UsbFacingDirection.FORWARD));
        }

        else if (logoFacing == "LEFT" && usbFacing == "UP") {
            parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                    RevHubOrientationOnRobot.LogoFacingDirection.LEFT,
                    RevHubOrientationOnRobot.UsbFacingDirection.UP));
        }

        else if (logoFacing == "RIGHT" && usbFacing == "UP") {
            parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                    RevHubOrientationOnRobot.LogoFacingDirection.RIGHT,
                    RevHubOrientationOnRobot.UsbFacingDirection.UP));
        }

        else if (logoFacing == "FORWARD" && usbFacing == "UP") {
            parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                    RevHubOrientationOnRobot.LogoFacingDirection.FORWARD,
                    RevHubOrientationOnRobot.UsbFacingDirection.UP));
        }

        else if (logoFacing == "BACKWARD" && usbFacing == "UP") {
            parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                    RevHubOrientationOnRobot.LogoFacingDirection.BACKWARD,
                    RevHubOrientationOnRobot.UsbFacingDirection.UP));
        }

        else if (logoFacing == "FORWARD" && usbFacing == "RIGHT") {
            parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                    RevHubOrientationOnRobot.LogoFacingDirection.FORWARD,
                    RevHubOrientationOnRobot.UsbFacingDirection.RIGHT));
        }

        else if (logoFacing == "UP" && usbFacing == "BACKWARD") {
            parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                    RevHubOrientationOnRobot.LogoFacingDirection.UP,
                    RevHubOrientationOnRobot.UsbFacingDirection.BACKWARD));
        }

        else if (logoFacing == "DOWN" && usbFacing == "FORWARD") {
            parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                    RevHubOrientationOnRobot.LogoFacingDirection.DOWN,
                    RevHubOrientationOnRobot.UsbFacingDirection.FORWARD));
        }

        else if (logoFacing == "FORWARD" && usbFacing == "LEFT") {
            parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                    RevHubOrientationOnRobot.LogoFacingDirection.FORWARD,
